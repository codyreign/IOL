...
function systemPrompt() {
  return [
    ...
    'Use inline CSS (or a single <style> block). Do not reference external CSS, JS, fonts, or images.',
    'Do not include external JS, inline event handlers, or scripts that submit real network requests.',
